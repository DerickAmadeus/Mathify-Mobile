...
export const API = {
  ...
  modules: {
    ...
    getById: (moduleId) => apiClient.get(`/api/modules/${moduleId}`),
    create: (moduleData) => apiClient.post('/api/modules', moduleData),
    getProgress: (moduleId, userId) => apiClient.get(`/api/modules/${moduleId}/progress?user_id=${userId}`),
    saveProgress: (moduleId, progressData) => apiClient.post(`/api/modules/${moduleId}/progress`, progressData),
    resetProgress: (moduleId, userId) => apiClient.post(`/api/modules/${moduleId}/reset-progress`, { user_id: userId }),
    deleteProgress: (moduleId, userId) => apiClient.delete(`/api/modules/${moduleId}/progress?user_id=${userId}`),
  },
